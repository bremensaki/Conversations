...
public final class Config {
	...
	public static final String LOGTAG = "jabberzac";

	public static final String BUG_REPORTS = "admin@jabberzac.org";


	public static final String DOMAIN_LOCK = "jabberzac.org"; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "jabberzac.org";
